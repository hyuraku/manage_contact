...
user_ids = []
user_ids << User.create(name: "Tim Holand",email: "dev01@gmail.com",password: "123456").id
user_ids << User.create(name: "Tom Ford",email: "dev02@gmail.com",password: "123456").id
